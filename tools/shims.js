...
function installShims(window, cfg = {}) {
  ...
  def(nav, 'hardwareConcurrency', 8, { get: () => 8 });      // Key 1994
  def(nav, 'deviceMemory', 8, { get: () => 8 });             // Key 1994
  def(nav, 'language', 'fr-FR', { get: () => 'fr-FR' });
  def(nav, 'languages', ['fr-FR', 'fr', 'en-US', 'en'], { get: () => ['fr-FR', 'fr', 'en-US', 'en'] });
  ...
  def(window.screen, 'width', 1920, { get: () => 1920 });
  def(window.screen, 'height', 1080, { get: () => 1080 });
  def(window.screen, 'availWidth', 1920, { get: () => 1920 });
  def(window.screen, 'availHeight', 1032, { get: () => 1032 });
  ...
  function makeGL() {
    ...
    return {
      ...
      getParameter(p) {
        ...
        switch (p) {
          case GL_CONSTANTS.UNMASKED_VENDOR_WEBGL: return 'Google Inc. (Intel)';
    ...
    constructor(url) {
      ...
      const g = {
        ...
        navigator: {
          ...
          language: 'fr-FR', languages: ['fr-FR', 'fr', 'en-US', 'en'], webdriver: false,
