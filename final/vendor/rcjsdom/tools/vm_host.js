...
const scriptSrc = fs.readFileSync(path.join(__dirname, '..', 'scripts', 'recaptcha_pretty.js'), 'utf8');
...
let err = null;
try {
  vm.runInContext(scriptSrc, ctx, { filename: 'recaptcha_pretty.js', timeout: 15000 });
